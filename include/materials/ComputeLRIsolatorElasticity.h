...
protected:
  ...
  /// Critical buckling load in compression
  Real _Fcr;
  ...
  /// Updated cavitation force
  Real _Fcn;

  /// Deformation at which, cavitation is initiated
  Real _uc;

  /// Initial value of cavitation deformation (will be updated each time step)
  Real _ucn;
