...
# i)  A constant axial load acting on isolator as gravity
# ii) Seismic loading as acceleration profiles in 3 directions (x,y and z)
...
[Functions]
  [acceleration_x]
    ...
    data_file = acceleration_x.csv
    format=columns
  []
  [acceleration_y]
    type = PiecewiseLinear
    data_file = acceleration_y.csv
    format=columns
  []
  [acceleration_z]
    type = PiecewiseLinear
    data_file = acceleration_z.csv
    format=columns
  []
  [force_x]
    type = PiecewiseLinear
